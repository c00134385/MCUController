...
#define KEY01  GPIO_ReadInputDataBit(GPIOA,GPIO_Pin_4)//读取按键0 
#define KEY02  GPIO_ReadInputDataBit(GPIOA,GPIO_Pin_5)//读取按键0
#define KEY03  GPIO_ReadInputDataBit(GPIOA,GPIO_Pin_6)//读取按键1
#define KEY04  GPIO_ReadInputDataBit(GPIOA,GPIO_Pin_7)//读取按键1
